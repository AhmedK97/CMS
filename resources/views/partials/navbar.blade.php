...
<div class="collapse navbar-collapse navbar-dark" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav ml-auto">
        <li class="nav-item">
            <a class="nav-link" href="{{ url('/') }}"> <i class="fa fa-home"></i>{{ __('site.Home') }}</a>
        </li>
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="fa fa-file"></i>{{__('site.Pages')}}
            </a>
        ...
        @else
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right  text-right" aria-labelledby="navbarDropdown">
                    @admin
                        <a class="dropdown-item" href="{{ route('dashboard') }}"><i class="fas fa-cog fa-fw"></i> Dashboard </a>
                    @endadmin
                    <a class="dropdown-item" href="{{ route('profile' , auth::user()->id) }}"><i class="fas fa-cog fa-fw"></i>لوحة التحكم</a>
                    <a class="dropdown-item" href=""><i class="far fa-user fa-fw"></i>{{__('site.Profile')}}</a>
                    <a class="dropdown-item" href="{{ route('settings') }}"><i class="fas fa-cog fa-fw"></i>{{__('site.Setting')}}</a>
